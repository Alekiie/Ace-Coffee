...
class MainActivity : BaseActivity() {
    ...
    private fun setVariable() {
        binding.apply {
            ...
            btn2.setOnClickListener{startListActivity(2,"Hot Coffee")}
            btn3.setOnClickListener{startListActivity(3,"Hot Drink")}
            ...
            btn7.setOnClickListener{startListActivity(7,"Restaurants")}
